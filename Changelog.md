...
## [0.5.13](https://github.com/pacman82/throttle/compare/v0.5.12...v0.5.13) (2026-07-06)
...
* Release container to Github Container Registry

0.5.6
-----

* Attempt to relase container to Github Container Registry
